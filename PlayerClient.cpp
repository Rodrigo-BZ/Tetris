...
PlayerClient::PlayerClient(QObject *parent): QObject(parent), m_clientSocket(new QTcpSocket(this)), m_loggedIn(false)
{
    ...
    connect(m_clientSocket, &QAbstractSocket::errorOccurred, this, &PlayerClient::error);
